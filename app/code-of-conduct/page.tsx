...
export default function CodeOfConductPage() {
  return (
    <main className="h-full bg-zinc-100 px-6 py-10 overflow-y-auto">
        <div className="mx-auto w-full max-w-5xl overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-xl shadow-indigo-100/40">
          ...
          <div className="p-8 md:p-10">
            <div className="mb-8 flex items-center justify-between">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-400">Community</p>
              <Link
                href="/"
            ...
            <div className="space-y-6 text-sm leading-7 text-zinc-700">
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">1. Be Respectful</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">2. Keep It Safe</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">3. Respect Privacy</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">4. No Spam or Abuse</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">5. Enforcement</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="text-lg font-semibold text-zinc-900">6. Report Concerns</h2>
                <p>
              ...
              <p className="pt-4 text-xs text-zinc-500">Last updated: March 2, 2026</p>
            </div>
          </div>
        </div>
      </main>
