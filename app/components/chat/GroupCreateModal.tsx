        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden max-h-[80vh]">
                <div className="px-6 py-4 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
                    ...
                    <button onClick={onClose} className="text-zinc-400 hover:text-zinc-600 p-1">âœ•</button>
                </div>
                ...
                <div className="p-6 space-y-4 overflow-y-auto">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border text-black border-zinc-200 rounded-xl px-4 py-2 text-sm focus:border-indigo-500 outline-none transition-colors bg-white placeholder-zinc-400"
                            value={groupName}
