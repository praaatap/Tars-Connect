...
export function MainHeader() {
    ...
    return (
        <header className="grid grid-cols-[1fr_auto_1fr] items-center border-b border-zinc-200 bg-white px-5 py-3 shrink-0 z-50">
            ...
            <nav className="hidden sm:flex items-center justify-center gap-6 justify-self-center">
                ...
                <Link href="/privacy-policy" className="text-sm font-semibold text-zinc-600 hover:text-indigo-600 transition-colors">
                    Privacy Policy
                </Link>
                <Link href="/code-of-conduct" className="text-sm font-semibold text-zinc-600 hover:text-indigo-600 transition-colors">
                    Code of Conduct
                </Link>
            </nav>
            ...
            <div className="flex items-center gap-3 justify-self-end">
                <Authenticated>
                    ...
                    <button
                        ...
                        className="relative p-2 text-zinc-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all"
                    >
