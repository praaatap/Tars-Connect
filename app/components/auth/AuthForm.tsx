            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full text-black border border-zinc-200 rounded-2xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all bg-white placeholder-zinc-400"
                    />
                </div>
                <SignInButton mode="modal">
